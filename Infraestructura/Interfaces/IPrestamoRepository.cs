...
namespace Infraestructura.Interfaces
{
    public interface IPrestamoRepository
    {
        ...
        Task<DbActionResult> AnularPagoAsync(int idPrestamo, int idPago, string motivo, string usuario, CancellationToken cancellationToken);
        Task<DbActionResult> EditarPagoAsync(PrestamoEditarPagoRequestDto request, string usuario, CancellationToken cancellationToken);
    }
}
