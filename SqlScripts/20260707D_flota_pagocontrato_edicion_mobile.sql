...
IF OBJECT_ID('flota.p_PagoContrato_EditarMobile', 'P') IS NOT NULL
BEGIN
    DROP PROCEDURE flota.p_PagoContrato_EditarMobile;
END;
GO

CREATE PROCEDURE flota.p_PagoContrato_EditarMobile
    @IdEmpresa INT,
    @IdEst CHAR(2),
    @IdPagoContrato INT,
    @FechaPago DATE,
