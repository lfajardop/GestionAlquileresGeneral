...
/*
Fix minimo y seguro - Flota operacion por intervalos

Produccion objetivo:
- DB_9FA64E_bdgas

Motivo:
- 20260716 fallo porque flota.operacion_dia.KmRecorrido es columna calculada
- este fix NO toca KmRecorrido en INSERT ni UPDATE
- este fix NO recrea ni borra flota.operacion_dia_intervalo si ya existe
- este fix NO toca flota.p_OperacionDia_Mobile_Obtener
- este fix NO toca recibos, pagos, caja, deuda, prestamos ni compensaciones
*/
GO
...
BEGIN
    ...
    BEGIN
        ...
        (
            ...
            ImporteGenerado,KmInicial,KmFinal,ImporteCombustible,GalonesCargados,
        ...
        (
            ...
            0,@KmInicio,NULL,0,0,NULL,0,@Observacion,@FechaHoraInicio,NULL,
            @Usuario,GETUTCDATE()
        );
...
PRINT 'OK: fix de intervalos creado sin modificar KmRecorrido.';
GO
