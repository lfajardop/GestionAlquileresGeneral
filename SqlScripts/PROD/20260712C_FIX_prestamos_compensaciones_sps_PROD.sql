/* =============================================================
   PRESTAMOS / COMPENSACIONES - FIX SPS PRODUCCION V2
...
IF OBJECT_ID('comp.p_simular', 'P') IS NOT NULL
    DROP PROCEDURE comp.p_simular;
GO
SET ANSI_NULLS ON;
GO
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE comp.p_simular
    @id_empresa INT,
    @id_est CHAR(2),
    @Cod_TipAnex CHAR(1),
    @Cod_Anxo CHAR(6),
...
IF OBJECT_ID('comp.p_aplicar', 'P') IS NOT NULL
    DROP PROCEDURE comp.p_aplicar;
GO
SET ANSI_NULLS ON;
GO
SET QUOTED_IDENTIFIER ON;
...
IF OBJECT_ID('comp.p_revertir', 'P') IS NOT NULL
    DROP PROCEDURE comp.p_revertir;
GO
SET ANSI_NULLS ON;
GO
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE comp.p_revertir
    @id_empresa INT,
    @id_est CHAR(2),
    @IdCompensacion INT,
    @MotivoReversa VARCHAR(300),
    @Usuario INT,
    @Ok BIT OUTPUT,
    @Mensaje VARCHAR(300) OUTPUT
AS
BEGIN
    ...
    BEGIN TRY
        ...
        IF ISNULL(LTRIM(RTRIM(@MotivoReversa)), '') = ''
            RAISERROR('Motivo de reversa obligatorio.', 16, 1);
...
IF OBJECT_ID('comp.p_listar', 'P') IS NOT NULL
    DROP PROCEDURE comp.p_listar;
GO
SET ANSI_NULLS ON;
GO
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE comp.p_listar
    @id_empresa INT,
    @id_est CHAR(2)
AS
BEGIN
...
IF OBJECT_ID('comp.p_obtener', 'P') IS NOT NULL
    DROP PROCEDURE comp.p_obtener;
GO
SET ANSI_NULLS ON;
GO
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE comp.p_obtener
    @id_empresa INT,
    @id_est CHAR(2),
    @IdCompensacion INT
AS
...
IF OBJECT_ID('comp.p_prestamos_cliente', 'P') IS NOT NULL
    DROP PROCEDURE comp.p_prestamos_cliente;
GO
SET ANSI_NULLS ON;
GO
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE comp.p_prestamos_cliente
    @id_empresa INT,
    @Cod_TipAnex CHAR(1),
    @Cod_Anxo CHAR(6),
    @FechaCorte DATE
...
PRINT 'Fix v2 de SPs comp listo para DB_9FA64E_bdgas.';
